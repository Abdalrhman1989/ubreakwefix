...
const dbPath = path.resolve(__dirname, 'ubreakwefix.db'); // Local to server dir
const db = new sqlite3.Database(dbPath);

console.log('Connected to ' + dbPath);

db.serialize(() => {
    console.log('Clearing old categories and updating schema...');
    ...
    // seedTree removed, called in callback above
});
