                    ...
                    <Link to="/reparationer" style={{ textDecoration: 'none' }}>
                        <div className="card-hover" style={{
                            ...
                            <div style={{ position: 'relative', zIndex: 2 }}>
                                ...
                                <h2 style={{ color: 'white', fontSize: '1.8rem', fontWeight: 'bold' }}>Reparation</h2>
                                <p style={{ color: 'rgba(255,255,255,0.9)', marginTop: '5px' }}>Få din enhed fixet i dag</p>
                            </div>
                            {/* Decorative Circle */}
                    ...
                    <Link to="/saelg-enhed" style={{ textDecoration: 'none' }}>
                        <div className="card-hover" style={{
                            ...
                            <div style={{ position: 'relative', zIndex: 2 }}>
                                ...
                                <h2 style={{ color: 'white', fontSize: '1.8rem', fontWeight: 'bold' }}>Sælg Din<br />Mobiltelefon</h2>
                            </div>
                    ...
                    <Link to="/saelg-skaerm" style={{ textDecoration: 'none' }}>
                        <div className="card-hover" style={{
                            ...
                            <div style={{ position: 'relative', zIndex: 2 }}>
                                ...
                                <h2 style={{ color: 'white', fontSize: '1.8rem', fontWeight: 'bold' }}>Sælg Din<br />Ødelagte Skærm</h2>
                            </div>
